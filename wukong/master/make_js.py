...
def addHead(name):
	head_path = os.path.join(ROOT_PATH, "wukong/master/static/js/__comp__"+ name.lower()+".js")
	g = open(head_path, "a")
...
def addSignal(name, signal):
	signal_path = os.path.join(ROOT_PATH, "wukong/master/static/js/__comp__"+ name.lower()+".js")
...
def addAction(name, action):
	action_path = os.path.join(ROOT_PATH, "wukong/master/static/js/__comp__"+ name.lower()+".js")
...
def addEnd(name):
	end_path = os.path.join(ROOT_PATH, "wukong/master/static/js/__comp__"+ name.lower()+".js")
	g = open(end_path, "a")
	g.write("}"+"\n"+"\n"+"\n"+
